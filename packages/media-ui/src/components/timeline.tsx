import { MEDIA_REQUEST_STATUS_LABELS, type MediaRequestEventView } from "@voltedge/media-contract";
  ...
  switch (event.kind) {
    ...
    case "status_changed":
      return event.toStatus
        ? `Status changed to ${MEDIA_REQUEST_STATUS_LABELS[event.toStatus]}`
        : "Status updated";
    case "assigned":
